...
<?php template_header("Program Offered | Harur International School", "View the programs offered at Harur International School, including curriculum details, academic offerings, and educational opportunities."); ?>
<section class="page-banner" id="program-offered">
    <h1>Program <br>Offered</h1>
</section>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 col-lg-4" data-aos="fade-up" data-aos-duration="800">
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <h4>Kindergarten</h4>
                        <p>A safe and joyful environment that develops early literacy, numeracy, communication, creativity, motor skills, and positive social habits through age-appropriate activities.</p>
                    </div>
                </div>
            </div>
            <!-- Primary School -->
            <div class="col-12 col-md-4 col-lg-4" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
                <div class="box">
                    <div class="image">
                        <img src="assets/images/primary-classes.webp" alt="Primary school students in a classroom" class="img-fluid">
                    </div>
                    <div class="content">
                        <div class="icon">
                        ...
                        <p>A strong foundation in language, mathematics, environmental learning, values, creativity, communication, and healthy learning habits.</p>
                    </div>
                </div>
            </div>
            <!-- Middle School -->
            <div class="col-12 col-md-4 col-lg-4" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <h4>Middle School </h4>
                        <p>A transition to deeper subject learning through exploration, experimentation, projects, problem-solving, and foundation-level academic support.</p>
                    </div>
                </div>
            </div>
            <!-- Secondary School -->
