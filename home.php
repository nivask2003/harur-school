    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000" data-bs-pause="false">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="assets/images/slider-1.webp" class="d-block w-100" alt="slider-2">
            </div>
            <div class="carousel-item">
                <img src="assets/images/slider-2.webp" class="d-block w-100" alt="slider-1">
            </div>
        </div>
        ...
        <div class="box" data-aos="fade-up">
            <div class="row">
                ...
                <div class="col-12 col-md-9 col-lg-9">
                    ...
                    <a href="program-offered.php" class="btn">Read More <span class="visually-hidden">about Kindergarten</span></a>
                </div>
            </div>
        </div>
        <div class="box" data-aos="fade-up" data-aos-delay="100">
            <div class="row">
                ...
                <div class="col-12 col-md-9 col-lg-9">
                    ...
                    <a href="program-offered.php" class="btn">Read More <span class="visually-hidden">about Primary School</span></a>
                </div>
            </div>
        </div>
        <div class="box" data-aos="fade-up" data-aos-delay="150">
            <div class="row">
                ...
                <div class="col-12 col-md-9 col-lg-9">
                    ...
                    <a href="program-offered.php" class="btn">Read More <span class="visually-hidden">about Middle School</span></a>
                </div>
            </div>
        </div>
        <div class="box" data-aos="fade-up" data-aos-delay="200">
            <div class="row">
                ...
                <div class="col-12 col-md-9 col-lg-9">
                    ...
                    <a href="program-offered.php" class="btn">Read More <span class="visually-hidden">about Secondary School</span></a>
                </div>
            </div>
        </div>
        <div class="box" data-aos="fade-up" data-aos-delay="250">
            <div class="row">
                ...
                <div class="col-12 col-md-9 col-lg-9">
                    ...
                    <a href="program-offered.php" class="btn">Read More <span class="visually-hidden">about Senior Secondary School</span></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="feature-box-classic-pro" data-aos="fade-right" data-aos-delay="100">
                    <div class="feature-box-inner">
                        ...
                        <h4 class="feature-box-title">Academic & Learning Facilities</h4>
                        <div class="fbox-content">Smart Classrooms, Laboratory, Language Learning & Robotics & Innovation Activities </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-box-classic-pro" data-aos="fade-down" data-aos-delay="150">
                    <div class="feature-box-inner">
                        ...
                        <h4 class="feature-box-title">Sports, Arts & Activity Facilities</h4>
                        <div class="fbox-content">Sports, Indoor & Outdoor Games, Music & Dance Studio, Art & Craft Room </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-box-classic-pro" data-aos="fade-left" data-aos-delay="200">
                    <div class="feature-box-inner">
                        ...
                        <h4 class="feature-box-title">Safety, Health & Student Support</h4>
                        <div class="fbox-content">CCTV Surveillance, Transport, Medical Care & First Aid, Green & Eco-Friendly Campus</div>
                    </div>
                </div>
            </div>
        </div>
